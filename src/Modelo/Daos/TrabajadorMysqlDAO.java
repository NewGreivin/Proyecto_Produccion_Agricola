...
public class TrabajadorMysqlDAO implements ITrabajadorDAO {
        ...
        try (Connection conn = conexion.getConnection();
            ...
            try (ResultSet rs = pst.executeQuery()) {
                if (rs.next()) {
                    ...
                    return new TrabajadorDTO(cedula, nombre, telefono, correo, puesto, horario, salario);
                }
            }
    ...
    public void eliminar(int cedula) {
        ...
        try (Connection conn = conexion.getConnection();
            ...
            throw new IllegalArgumentException("No se pudo eliminar el trabajador", e);
        }
    }
}
