...
public class dlgBuscarAlmacenamiento extends javax.swing.JDialog {
    ...
    public dlgBuscarAlmacenamiento(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("Buscar Almacenamiento");
        ...
        tblReservas.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Producto", "Cantidad", "Fecha de Ingreso", "Fecha de Salida"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                dlgBuscarAlmacenamiento dialog = new dlgBuscarAlmacenamiento(new javax.swing.JFrame(), true);
